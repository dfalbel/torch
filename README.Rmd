...
[![Travis build status](https://travis-ci.org/dfalbel/torch.svg?branch=master)](https://travis-ci.org/dfalbel/torch)
[![Coverage status](https://codecov.io/gh/dfalbel/torch/branch/master/graph/badge.svg)](https://codecov.io/github/dfalbel/torch?branch=master)

torch from R!

> A proof of concept for calling libtorch functions from R. API will change! Use at your own risk.
...
On Linux the fastest way to get started is to run on `bash`:
...
On MacOS the following should just work too. First install libtorch with:
